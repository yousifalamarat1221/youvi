...
export function BasicReferralSubmission() {
  const [currentReferrals, setCurrentReferrals] = useState(47) // Mock current count
  ...
  const downloadTemplate = () => {
    const template = `قائمة الإحالات - يوفي كاش
===================
...
`
    ...
    a.href = url
    a.download = "youvi-cash-referrals-template.txt"
    a.click()
    ...
    <div className="container mx-auto px-4 py-8 max-w-6xl">
      ...
      <div className="text-center mb-12">
        ...
        <h1 className="text-4xl md:text-5xl font-black text-gray-900 mb-4">
          <span className="bg-gradient-to-r from-green-600 to-blue-600 bg-clip-text text-transparent">
            إرسال الإحالات للباقة الأساسية
          </span>
        </h1>
        <h2 className="text-2xl md:text-3xl font-bold text-gray-700 mb-6">Submit Referrals for Basic Package</h2>
        ...
        <div className="max-w-4xl mx-auto bg-white/90 backdrop-blur-sm rounded-2xl p-6 shadow-xl">
          <div className="grid md:grid-cols-2 gap-6">
            <p className="text-lg text-gray-700 text-right">
              أرسل إحالاتك المؤكدة للحصول على الباقة الأساسية والبدء في الربح
            </p>
            <p className="text-lg text-gray-700 text-left">
              Submit your confirmed referrals to get the Basic package and start earning
            </p>
          </div>
        </div>
      </div>
      ...
      {showSuccess && (
        <div className="fixed top-4 right-4 z-50 animate-bounce">
          <Card className="border-green-500 border-2 bg-green-50 shadow-xl">
            ...
            <CardHeader>
              <CardTitle className="flex items-center justify-between">
                ...
                <Badge
                  ...
                  className={currentReferrals >= requiredReferrals ? "bg-green-600" : ""}
                >
              ...
              {currentReferrals < requiredReferrals ? (
                <div className="bg-yellow-50 p-4 rounded-lg border border-yellow-200">
                  <div className="flex items-center mb-2">
                    ...
                    <span className="font-semibold text-yellow-800">تحتاج {remainingReferrals} إحالة إضافية</span>
                  </div>
                  <p className="text-sm text-yellow-700">
                    Need {remainingReferrals} more referrals to qualify for the Basic package
                  </p>
                </div>
              ) : (
                <div className="bg-green-50 p-4 rounded-lg border border-green-200">
                  <div className="flex items-center mb-2">
                    ...
                    <span className="font-semibold text-green-800">مبروك! أكملت العدد المطلوب</span>
                  </div>
          ...
          <Card className="border-2 border-blue-200">
            <CardHeader>
              <CardTitle className="flex items-center">
                <Upload className="h-6 w-6 text-blue-600 ml-2" />
                <div>
        ...
        <div className="space-y-6">
          ...
          <Card className="border-2 border-green-200 bg-green-50">
            ...
            <CardContent className="space-y-4">
              <div className="text-center">
                <div className="text-3xl font-bold text-green-600 mb-2">1,000 ج.س</div>
                <p className="text-sm text-green-700">رسوم الاشتراك</p>
                <p className="text-xs text-green-600">أو ما يعادله بالدولار</p>
              </div>

              <div className="space-y-2 text-sm">
                <div className="flex justify-between">
                  <span className="text-green-700">المطلوب:</span>
                  <span className="font-semibold">100 إحالة</span>
                </div>
                <div className="flex justify-between">
                  <span className="text-green-700">العمولة:</span>
                  <span className="font-semibold">1,000 ج.س</span>
                </div>
                <div className="flex justify-between">
                  <span className="text-green-700">Required:</span>
                  <span className="font-semibold">100 Referrals</span>
                </div>
                <div className="flex justify-between">
                  <span className="text-green-700">Commission:</span>
                  <span className="font-semibold">1,000 SDG</span>
                </div>
              </div>
