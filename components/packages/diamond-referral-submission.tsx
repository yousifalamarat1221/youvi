...
export function DiamondReferralSubmission() {
  const [currentReferrals, setCurrentReferrals] = useState(7) // Mock current count
  ...
  const downloadTemplate = () => {
    const template = `قائمة الإحالات - يوفي كاش (الباقة الماسية VIP)
===============================================
...
`
    ...
    a.href = url
    a.download = "youvi-cash-diamond-referrals-template.txt"
    a.click()
    ...
    <div className="container mx-auto px-4 py-8 max-w-6xl">
      ...
      <div className="text-center mb-12">
        <div className="inline-flex items-center justify-center w-20 h-20 bg-purple-100 rounded-full mb-6">
          <Diamond className="h-10 w-10 text-purple-600" />
        </div>
        <h1 className="text-4xl md:text-5xl font-black text-gray-900 mb-4">
          <span className="bg-gradient-to-r from-purple-600 to-pink-600 bg-clip-text text-transparent">
            إرسال الإحالات للباقة الماسية
          </span>
        </h1>
        <h2 className="text-2xl md:text-3xl font-bold text-gray-700 mb-6">Submit Referrals for Diamond Package</h2>
        ...
        <div className="max-w-4xl mx-auto bg-white/90 backdrop-blur-sm rounded-2xl p-6 shadow-xl">
          <div className="grid md:grid-cols-2 gap-6">
            <p className="text-lg text-gray-700 text-right">
              أرسل إحالاتك المؤكدة للحصول على الباقة الماسية الحصرية مع خدمة VIP
            </p>
            <p className="text-lg text-gray-700 text-left">
              Submit your confirmed referrals to get the exclusive Diamond package with VIP service
            </p>
          </div>
        </div>
      </div>
      ...
      {showSuccess && (
        <div className="fixed top-4 right-4 z-50 animate-bounce">
          <Card className="border-purple-500 border-2 bg-purple-50 shadow-xl">
            <CardContent className="p-4">
              <div className="flex items-center text-purple-700">
                <CheckCircle className="h-6 w-6 ml-2" />
                <div>
                  <span className="font-bold">تم إرسال الإحالات بنجاح!</span>
                  <p className="text-sm">سيتم مراجعتها خلال 12 ساعة (أولوية VIP)</p>
                </div>
              </div>
            </CardContent>
          </Card>
          ...
          <Card className="border-2 border-purple-200 bg-gradient-to-br from-purple-50 to-pink-50">
            <CardHeader>
              <CardTitle className="flex items-center justify-between">
                ...
                <Badge
                  ...
                  className={currentReferrals >= requiredReferrals ? "bg-purple-600" : ""}
                >
            ...
            <CardContent className="space-y-6">
              <div className="text-center">
                ...
                <p className="text-sm text-purple-600 font-semibold">أقل عدد إحالات مطلوب!</p>
              </div>
              ...
              {currentReferrals < requiredReferrals ? (
                <div className="bg-purple-50 p-4 rounded-lg border border-purple-200">
                  <div className="flex items-center mb-2">
                    ...
                    <span className="font-semibold text-purple-800">تحتاج {remainingReferrals} إحالة إضافية فقط</span>
                  </div>
                  <p className="text-sm text-purple-700">
                    Need only {remainingReferrals} more referrals to qualify for the Diamond package
                  </p>
                </div>
              ) : (
                <div className="bg-purple-50 p-4 rounded-lg border border-purple-200">
                  <div className="flex items-center mb-2">
                    ...
                    <span className="font-semibold text-purple-800">مبروك! أكملت العدد المطلوب</span>
                  </div>
                  <p className="text-sm text-purple-700">
            ...
            <CardContent>
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                <div className="flex items-center p-3 bg-white rounded-lg border border-purple-200">
                  <Star className="h-5 w-5 text-purple-600 ml-3" />
                  <div>
                    <h4 className="font-semibold text-gray-900 text-sm">مدير حساب شخصي</h4>
                    <p className="text-xs text-gray-600">Personal Account Manager</p>
                  </div>
                </div>
                <div className="flex items-center p-3 bg-white rounded-lg border border-purple-200">
                  <Diamond className="h-5 w-5 text-purple-600 ml-3" />
                  <div>
                    <h4 className="font-semibold text-gray-900 text-sm">عمولة ترقية 25,000 ج.س</h4>
                    <p className="text-xs text-gray-600">25,000 SDG Upgrade Commission</p>
                  </div>
                </div>
              </div>
            </CardContent>
          ...
          <Card className="border-2 border-purple-200">
            <CardHeader>
              <CardTitle className="flex items-center">
                <Upload className="h-6 w-6 text-purple-600 ml-2" />
                <div>
...
محمد خالد - شاهد في 2024/01/16"
                ...
                <Button
                  type="submit"
                  className="w-full h-12 text-lg font-bold bg-gradient-to-r from-purple-500 to-purple-600 hover:from-purple-600 hover:to-purple-700"
        ...
        <div className="space-y-6">
          ...
          <Card className="border-2 border-purple-200 bg-purple-50">
            ...
            <CardContent className="space-y-4">
              <div className="text-center">
                <div className="text-3xl font-bold text-purple-600 mb-2">100,000 ج.س</div>
                <p className="text-sm text-purple-700">رسوم الاشتراك</p>
                <p className="text-xs text-purple-600">أو ما يعادله بالدولار</p>
              </div>

              <div className="space-y-2 text-sm">
                <div className="flex justify-between">
                  <span className="text-purple-700">المطلوب:</span>
                  <span className="font-semibold">10 إحالات</span>
                </div>
                <div className="flex justify-between">
                  <span className="text-purple-700">العمولة:</span>
                  <span className="font-semibold">4 مستويات + VIP</span>
                </div>
                <div className="flex justify-between">
                ...
                <div className="flex justify-between">
                  <span className="text-purple-700">Commission:</span>
                  <span className="font-semibold">4 Levels + VIP</span>
                </div>
              </div>

              <Button variant="outline" className="w-full" asChild>
                <Link href="/packages/diamond">
            ...
            <CardContent className="space-y-3">
              <div className="text-sm text-purple-800 space-y-2">
                ...
                <ul className="space-y-1 text-xs">
                  ...
                  <li>• سيتم مراجعة الإحالات خلال 12 ساعة (أولوية VIP)</li>
                ...
                <ul className="space-y-1 text-xs">
                  ...
                  <li>• Referrals will be reviewed within 12 hours (VIP priority)</li>
          ...
          <Card className="border-purple-200 bg-gradient-to-r from-purple-50 to-pink-50">
            <CardContent className="p-4 text-center">
              ...
              <h4 className="font-semibold text-purple-800 mb-2">دعم VIP حصري</h4>
              <p className="text-sm text-purple-700 mb-3">Exclusive VIP Support</p>
              <Button variant="outline" size="sm" className="w-full border-purple-300">
                تواصل مع مدير حسابك
              </Button>
            </CardContent>
          </Card>
